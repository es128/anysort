...
generateAnysort = function(priCriteria) {
  var priMatcher, sorter;
  if (priCriteria == null) {
    priCriteria = returnFalse;
  }
  priMatcher = anymatch.matcher(priCriteria);
  return sorter = function(a, b, criteria) {
    ...
    if (hasA && !hasB) {
      ...
      return sorter(a, b, criteria.slice(indexOfA + 1));
    } else if (a < b) {
      return -1;
    } else if (a > b) {
      return 1;
